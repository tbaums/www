    ...
    <div>
        <div v-for="event in events">
            <div class="date-box">
                ...
                <div class="date-number">{{ new Date(event.frontmatter.date).getDate() }}</div>
                <div class="date-month">{{ new Date(event.frontmatter.date).getMonth() | monthToShortName }}</div>
            </div>
            <div class="event">
                <div class="date">
                    <div>
                        <span class="right" v-if="event.frontmatter.location">{{ event.frontmatter.location }}</span>
                    </div>
                </div>
